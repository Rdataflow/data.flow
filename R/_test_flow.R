...
flow(resources = resource1, dir.commit = "C:/temp/daten", dir.output = "c:/temp/data_loaded/",
     dir.input = "C:/temp/data_input/", dir.input.old = "C:/temp/data_input.old/", dir.log = "C:/temp/data_log/", output.type = "csv", log.file = "C:/temp/data_log/data.flow.summary.log")
